  ...
  return (
    <>
      <footer class="bg-gray-800">
        <div class="mx-auto max-w-screen-xl pt-8 sm:px-6 lg:px-8">
          <div class="mx-auto max-w-md">
            ...
            <div class="mt-6 bg-white rounded-xl">
              <form class="w-full">
                ...
                <div className="p-1 border border-gray-400 rounded-xl focus-within:ring sm:flex sm:items-center sm:gap-4">
                  <input
                    id="email"
                    type="email"
                    placeholder="john@doe.com"
                    className="w-full text-gray-800 border-0 border-transparent focus:border-transparent focus:ring-0 sm:text-sm"
                  />

                  <button
                    class="mt-1 w-full rounded-xl bg-green-400 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
                  >
                    Subscribe
                  </button>
                </div>
          ...
          <div class="pt-6 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">

				...
				<div className="flex justify-between items-center duration-700">
					<div class="mt-11 p-2 w-[250px] transform overflow-hidden rounded-xl bg-gray-800 shadow-md duration-300 hover:scale-105 hover:shadow-lg">
						<div className="relative">
							<img class="h-[250px] w-full rounded-xl object-cover object-center" src="https://images.unsplash.com/photo-1674296115670-8f0e92b1fddb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="Product Image" />
						...
						<div class="p-">
							...
							<div className="mt-2 flex justify-between items-center">
								...
								<button type="button" class="flex cursor-pointer gap-x-1 rounded-xl py-2 px-4 bg-green-400 hover:text-gray-800 hover:bg-gray-100">

...
export default function Carousel() {
	...
	const dots = slides.map((slide, slideIndex) => {
		return (
			<div
				...
				className={currentIndex === slideIndex ? 'text-blue-700 text-2xl cursor-pointer' : 'text-2xl cursor-pointer'}
			>
				<RxDotFilled />
			</div>
		)
	...
	return (
		<div className='h-[450px] max-sm:h-[350px] lg:h-[550px] rounded-2xl w-full m-auto relative group'>
			<img
